...
Singleton {
    ...
    // Config.qml reads from here, NOT from StateService
    ...
    Connections {
        ...
        function onStateLoaded() {
            const themeName = StateService.get("theme.name", "tokyonight");
    ...
    function _applyKitty(terminal) {
        ...
        const lines = [
            ...
            "url_color " + terminal.urlColor,
            "cursor " + terminal.cursor,
            "cursor_text_color " + terminal.cursorTextColor,
            "",
            "# Tabs",
            "active_tab_background " + terminal.activeTabBackground,
            "active_tab_foreground " + terminal.activeTabForeground,
            "inactive_tab_background " + terminal.inactiveTabBackground,
            "inactive_tab_foreground " + terminal.inactiveTabForeground,
            "",
            "# Windows",
            "active_border_color " + terminal.activeBorderColor,
            "inactive_border_color " + terminal.inactiveBorderColor,
            "",
            "# Normal",
            "color0 " + terminal.color0,
            ...
            "color7 " + terminal.color7,
            "",
            "# Bright",
            "color8  " + terminal.color8,
            ...
            "color15 " + terminal.color15,
            "",
            "# Extended",
            "color16 " + terminal.color16,
            "color17 " + terminal.color17,
            ""
        ];
        ...
        kittyProc.command = [
            "bash", "-c",
            "cat > " + shellEscape(kittyThemePath) + " << 'THEME_EOF'\n" + content + "THEME_EOF\n" +
    ...
    function _applyNeovim(neovimConfig) {
        if (!neovimConfig || !neovimConfig.colorscheme) return;
        ...
        nvimProc.command = [
            "bash", "-c",
            "echo '" + colorscheme + "' > " + shellEscape(nvimThemePath) + " && " +
    ...
    Process {
        ...
        command: [
            "bash", "-c",
            "ls -1 '" + root.themesDir + "'/*.json 2>/dev/null | sed 's|.*/||;s|\\.json$||' | sort"
        ]
    ...
    Process {
        ...
        command: [
            "bash", "-c",
            "for f in '" + root.themesDir + "'/*.json; do cat \"$f\"; echo '---THEME_SEP---'; done"
        ]
        property string _buffer: ""
